...
<div class="cart-sidebar" id="cartSidebar">
    ...
    <div class="cart-footer">
        <div class="d-flex spacecart">
            <div class="py-2"><p>TOTAL ITEMS</p></div>
            <div><p class="pt-2" id="totalItems">0</p></div>
        </div>
        <div class="d-flex spacecart">
        ...
        <button class="checkout-btn" onclick="proceedToCheckout()"><a href="{{ route('cart.checkout') }}">Proceed to Checkout</a></button>
    </div>
</div>
...
<div id="mySidebar" class="sidebar">
  ...
  <div class="DOTdrop pt-5">
      <a href="{{ route('profile') }}"><h6>MY PROFILE</h6></a>
  </div>
  <div class="DOTdrop">
      <a href=""><h6>MY ORDERS</h6></a>
  </div>
  <div class="DOTdrop">
      <a href="{{ route('address') }}"><h6>SAVED ADDRESSES</h6></a>
  </div>
  <div class="DOTdrop">
      <a href="{{url('page/return-policy')}}"><h6>RETURN POLICY</h6></a>
  </div>
  <div class="DOTdrop">
      <a href="{{ route('contact') }}"><h6>CONTACT US</h6></a>
  </div>
  <div class="DOTdrop">
      <a href="{{ route('logout') }}"><h6>SIGN OUT</h6></a>
  ...
  <div class="offcanvas offcanvas-end navbackground" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <div class="offcanvas-body ms-auto">
      ...
      <form class="d-flex search-box" role="search" action="{{ route('search') }}" method="GET">
        <input class="form-control me-2" required type="search" name="keyword" placeholder="Search" aria-label="Search" value="{{ request()->get('keyword') }}">
      ...
      <ul class="navbar-nav p-1">
        ...
        @else
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('weblogin') }}">My Wishlist</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('weblogin') }}">My Cart</a>
          </li>
        @endif
      </ul>
    </div>
    ...
    <div class="container-fluid py-4">
      <div class="row pb-2">
        <div class="col-md-4 imagefot">
         <a href="#"><img class="logos" src="{{ asset('public/web') }}/images/SutramWhite.png" width="90%"></a>
        ...
        <h4 class="text-white">Customer&nbsp;Service</h4>
          ...
          <p class="m-1"><a class="" href="{{url('page/privacy-policy')}}">Privacy & Policy</p></a>
              <p class="m-1"><a class="" href="{{url('page/terms-and-condition')}}">Terms & Conditions</p></a>
                  <p class="m-1"><a class="" href="{{url('page/cancellation-and-refund-policy')}}">Cancellation & RefundPolicy</p></a>
                      <p class="m-1"><a class="" href="{{url('page/shipping-and-delivery-policy')}}">Shipping & DeliveryPolicy</p></a>
        </div>
        <div class="col-md-2 shop">
          <h4 class="text-white">Shop</h4>
          <p class="m-1"><a class="" href="{{ url('products/men') }}">Men</p></a>
          <p class="m-1"><a class="" href="{{ url('products/women') }}">Women</p></a>
          <p class="m-1"><a class="" href="{{ url('products/perfume') }}">Perfume</p></a>

        </div>
        <div class="col-md-2 aboutfot">
        <h4 class="text-white">Quick Links</h4>
        @auth
            <p class="m-1"><a class="" href="{{route('profile')}}">My Profile </p></a>
        @endauth

          <p class="m-1"><a class="" href="{{route('contact')}}">Contact Us</p></a>
          @auth
          <p class="m-1"><a class="" href="orderdetail.php">My Orders</p></a>

          @endauth
          {{-- <p class="m-1"><a class="" href=""></p></a> --}}
        </div>
...
<script type="text/javascript">
    ...
    function updateCartItemQty(element, cartId, isIncrement) {
        ...
        // Calculate new quantity based on isIncrement
        let newQty = isIncrement ? currentQty + 1 : Math.max(1, currentQty - 1); // Ensure quantity is at least 1

        // Update the quantity via AJAX
        $.ajax({
            ...
            success: function(response) {
                loadCartItems(); // Refresh cart after updating quantity
            },
            error: function(error) {
